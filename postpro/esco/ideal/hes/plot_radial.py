...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,0]/refer.iloc[0,0] , 'y', lw=lwh, label="$H(T)$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,0]/refer.iloc[0,0] , 'm', lw=lwh, label="$H(s)$")
...
fig1.savefig("refer_ideal_hessian_rho.pdf")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("refer_ideal_hessian_m.pdf")
...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,3]/refer.iloc[0,3] , 'y', lw=lwh, label="$H(T)$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,3]/refer.iloc[0,3] , 'm', lw=lwh, label="$H(s)$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig3.savefig("refer_ideal_hessian_t.pdf")
