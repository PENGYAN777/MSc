...
axes.plot(gd.iloc[:,6]/D , gd.iloc[:,2]/gd.iloc[0,2] , 'r', lw=lwh, label="aniso $\\rho$")
axes.plot(gm.iloc[:,6]/D , gm.iloc[:,2]/gm.iloc[0,2] , 'b', lw=lwh, label="aniso $M$")
axes.plot(gp.iloc[:,6]/D , gp.iloc[:,2]/gp.iloc[0,2] , 'g', lw=lwh, label="aniso $P$")
axes.plot(gt.iloc[:,6]/D , gt.iloc[:,2]/gt.iloc[0,2] , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,6]/D , ge.iloc[:,2]/gt.iloc[0,2] , 'm', lw=lwh, label="aniso $s$")
...
fig1.savefig("refer_ideal_aniso_p.pdf")
