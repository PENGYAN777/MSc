...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,0]/refer.iloc[0,0]*11.29 , 'y', lw=lwh, label="$\\nabla T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,0]/refer.iloc[0,0]*11.29 , 'm', lw=lwh, label="$\\nabla s$")
...
fig1.savefig("refer_nn_gra_rho.pdf")
...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,3]/refer.iloc[0,3]*300 , 'y', lw=lwh, label="$\\nabla T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,3]/refer.iloc[0,3]*300 , 'm', lw=lwh, label="$\\nabla s$")
