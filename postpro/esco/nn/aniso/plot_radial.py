...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,0]/refer.iloc[0,0] , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,0]/refer.iloc[0,0] , 'm', lw=lwh, label="aniso $s$")
...
fig1.savefig("refer_nn_aniso_rho.pdf")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("refer_nn_aniso_m.pdf")
...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,3]/refer.iloc[0,3] , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,3]/refer.iloc[0,3] , 'm', lw=lwh, label="aniso $s$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig3.savefig("refer_nn_aniso_t.pdf")
