...
axes.plot(gd.iloc[:,7]/D , gd.iloc[:,0]/refer.iloc[0,0]*12.9 , 'r', lw=lwh, label="$H(\\rho)$")
axes.plot(gm.iloc[:,7]/D , gm.iloc[:,0]/refer.iloc[0,0]*12.9 , 'b', lw=lwh, label="$H(M)$")
axes.plot(gp.iloc[:,7]/D , gp.iloc[:,0]/refer.iloc[0,0]*12.9 , 'g', lw=lwh, label="$H(P)$")
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,0]/refer.iloc[0,0]*12.9, 'y', lw=lwh, label="$H(T)$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,0]/refer.iloc[0,0]*12.9 , 'm', lw=lwh, label="$H(s)$")
...
fig1.savefig("refer_mm_hessian_rho.pdf")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("refer_mm_hessian_m.pdf")

fig3 = plt.figure( dpi=300)
lwh = 2
axes = fig3.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(refer.iloc[:,7]/D , refer.iloc[:,3]/refer.iloc[0,3] , 'k', lw=lwh, label="reference")
axes.plot(gd.iloc[:,7]/D , gd.iloc[:,3]/refer.iloc[0,3]*300, 'r', lw=lwh, label="$H(\\rho)$")
axes.plot(gm.iloc[:,7]/D , gm.iloc[:,3]/refer.iloc[0,3]*300 , 'b', lw=lwh, label="$H(M)$")
axes.plot(gp.iloc[:,7]/D , gp.iloc[:,3]/refer.iloc[0,3]*300 , 'g', lw=lwh, label="$H(P)$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig3.savefig("refer_mm_hessian_t.pdf")
