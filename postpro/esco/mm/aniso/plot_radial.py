...
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,0]/refer.iloc[0,0]*12.9 , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,0]/refer.iloc[0,0]*12.9 , 'm', lw=lwh, label="aniso $s$")
...
fig1.savefig("refer_mm_aniso_rho.pdf")

fig2 = plt.figure( dpi=300)
lwh = 2
axes = fig2.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(refer.iloc[:,7]/D , refer.iloc[:,1] , 'k', lw=lwh, label="reference")
axes.plot(gd.iloc[:,7]/D , gd.iloc[:,1], 'r', lw=lwh, label="aniso $\\rho$")
axes.plot(gm.iloc[:,7]/D , gm.iloc[:,1], 'b', lw=lwh, label="aniso $M$")
axes.plot(gp.iloc[:,7]/D , gp.iloc[:,1], 'g', lw=lwh, label="aniso $P$")
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,1] , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,1] , 'm', lw=lwh, label="aniso $s$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("refer_mm_aniso_m.pdf")

fig3 = plt.figure( dpi=300)
lwh = 2
axes = fig3.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(refer.iloc[:,7]/D , refer.iloc[:,3]/refer.iloc[0,3] , 'k', lw=lwh, label="reference")
axes.plot(gd.iloc[:,7]/D , gd.iloc[:,3]/refer.iloc[0,3] , 'r', lw=lwh, label="aniso $\\rho$")
axes.plot(gm.iloc[:,7]/D , gm.iloc[:,3]/refer.iloc[0,3] , 'b', lw=lwh, label="aniso $M$")
axes.plot(gp.iloc[:,7]/D , gp.iloc[:,3]/refer.iloc[0,3] , 'g', lw=lwh, label="aniso $P$")
axes.plot(gt.iloc[:,7]/D , gt.iloc[:,3]/refer.iloc[0,3]*300 , 'y', lw=lwh, label="aniso $T$")
axes.plot(ge.iloc[:,7]/D , ge.iloc[:,3]/refer.iloc[0,3]*300 , 'm', lw=lwh, label="aniso $s$")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig3.savefig("refer_mm_aniso_t.pdf")
