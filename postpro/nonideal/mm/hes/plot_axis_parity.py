...
ax.scatter(ref_p, gd_p, color='r', label="$H(\\rho)$", marker='o')
ax.scatter(ref_p, gm_p, color='b', label="$H(M)$", marker='o')
ax.scatter(ref_p, gp_p, color='g', label="$H(P)$", marker='o')
ax.scatter(ref_p, gt_p, color='y', label="$H(T)$", marker='o')
ax.scatter(ref_p, dm_p, color='m', label="$H(\\rho)$ + $H(M)$", marker='o')
ax.scatter(ref_p, dp_p, color='c', label="$H(\\rho)$ + $H(P)$", marker='o')
ax.scatter(ref_p, pm_p, color='orange', label="$H(P)$ + $H(M)$", marker='o')
...
plt.savefig("parity_non_hes_p.pdf", bbox_inches='tight')
plt.show()
