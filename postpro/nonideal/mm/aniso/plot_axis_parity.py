...
ax.scatter(ref_p, gd_p, color='r', label="aniso $\\rho$", marker='o')
ax.scatter(ref_p, gm_p, color='b', label="aniso $M$", marker='o')
ax.scatter(ref_p, gp_p, color='g', label="aniso $P$", marker='o')
ax.scatter(ref_p, gt_p, color='y', label="aniso $T$", marker='o')
ax.scatter(ref_p, dm_p, color='m', label="aniso $\\rho$ + aniso $M$", marker='o')
ax.scatter(ref_p, dp_p, color='c', label="aniso $\\rho$ + aniso $P$", marker='o')
ax.scatter(ref_p, pm_p, color='orange', label="aniso $P$ + aniso $M$", marker='o')
...
plt.savefig("parity_non_aniso_p.pdf", bbox_inches='tight')
plt.show()
