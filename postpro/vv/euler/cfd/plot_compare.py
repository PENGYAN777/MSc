...
# axes.plot(mesh6.iloc[:,-8]/D , mesh6.iloc[:,7]/P0, 'r', lw=lwh, label="166k")
# axes.plot(mesh7.iloc[:,-8]/D , mesh7.iloc[:,7]/P0, 'g', lw=lwh, label="213k")
# axes.plot(mesh8.iloc[:,-8]/D , mesh8.iloc[:,7]/P0, 'b', lw=lwh, label="272k")
...
# axes.plot(mesh6.iloc[:,-8]/D , mesh6.iloc[:,3], 'r', lw=lwh, label="166k")
# axes.plot(mesh7.iloc[:,-8]/D , mesh7.iloc[:,3], 'g', lw=lwh, label="213k")
# axes.plot(mesh8.iloc[:,-8]/D , mesh8.iloc[:,3], 'b', lw=lwh, label="272k")
# # axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
