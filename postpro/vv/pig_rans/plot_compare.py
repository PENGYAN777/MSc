...
axes.plot(mesh7.iloc[:,-5]/D , mesh7.iloc[:,9]/P0, 'r', lw=lwh, label="120k")
axes.plot(mesh8.iloc[:,-5]/D , mesh8.iloc[:,9]/P0, 'g', lw=lwh, label="161k")
axes.plot(mesh9.iloc[:,-5]/D , mesh9.iloc[:,9]/P0, 'b', lw=lwh, label="221k")
...
axes.plot(mesh7.iloc[:,-5]/D , mesh7.iloc[:,5], 'r', lw=lwh, label="120k")
axes.plot(mesh8.iloc[:,-5]/D , mesh8.iloc[:,5], 'g', lw=lwh, label="161k")
axes.plot(mesh9.iloc[:,-5]/D , mesh9.iloc[:,5], 'b', lw=lwh, label="221k")
# axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
