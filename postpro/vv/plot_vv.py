...
euler = pd.read_csv("euler/stable/m8new.csv", ",", skiprows=0)
...
axes.plot(euler.iloc[:,-7]/D1 , euler.iloc[:,-3]/P0, 'b', lw=lwh, label="EULER $P_i$")
axes.plot(rans.iloc[:,-8]/D2 , rans.iloc[:,-4]/P0, 'b--', lw=lwh, label="RANS $P_i$")
