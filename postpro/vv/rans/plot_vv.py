...
axes.plot(ex.iloc[:,0]+0.05 , ex.iloc[:,1], 'ko', lw=lwh, label="Katanoda et.al Ex $P_i$")
...
axes.plot(sb.iloc[:,-8]/D , sb.iloc[:,-4]/P0, 'b', lw=lwh, label="RANS $P_i$")
